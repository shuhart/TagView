...
class TagViewLayoutInflater extends LayoutInflater implements TagViewActivityFactory {
    ...
    protected TagViewLayoutInflater(Context context) {
        super(context);
        tagViewFactory = new TagViewFactory();
        setUpLayoutFactories(false);
    }

    protected TagViewLayoutInflater(LayoutInflater original, Context newContext, final boolean cloned) {
    ...
    public LayoutInflater cloneInContext(Context newContext) {
        return new TagViewLayoutInflater(this, newContext, true);
    }
    ...
    public void setFactory(Factory factory) {
        ...
        if (!(factory instanceof WrapperFactory)) {
            super.setFactory(new WrapperFactory(factory, this, tagViewFactory));
        } else {
    ...
    public void setFactory2(Factory2 factory2) {
        ...
        if (!(factory2 instanceof WrapperFactory2)) {
            super.setFactory2(new WrapperFactory2(factory2, tagViewFactory));
        } else {
    ...
    private void setPrivateFactoryInternal() {
        ...
        if (setPrivateFactoryMethod != null) {
            ReflectionUtils.invokeMethod(this,
                    ...
                    new PrivateWrapperFactory2((Factory2) getContext(), this, tagViewFactory));
        }
        setPrivateFactory = true;
    }
    ...
    public View onActivityCreateView(View parent, View view, String name, Context context, AttributeSet attrs) {
        return tagViewFactory.onViewCreated(createCustomViewInternal(parent, view, name, context, attrs), context, attrs);
    }
    ...
    protected View onCreateView(View parent, String name, AttributeSet attrs) throws ClassNotFoundException {
        return tagViewFactory.onViewCreated(super.onCreateView(parent, name, attrs),
                getContext(), attrs);
    }
    ...
    protected View onCreateView(String name, AttributeSet attrs) throws ClassNotFoundException {
        ...
        return tagViewFactory.onViewCreated(view, view.getContext(), attrs);
    }
    ...
    private static class WrapperFactory implements Factory {
        ...
        private final TagViewLayoutInflater mInflater;
        private final TagViewFactory mTagViewFactory;

        public WrapperFactory(Factory factory, TagViewLayoutInflater inflater, TagViewFactory tagViewFactory) {
            mFactory = factory;
            mInflater = inflater;
            mTagViewFactory = tagViewFactory;
        }

        @Override
        public View onCreateView(String name, Context context, AttributeSet attrs) {
            return mTagViewFactory.onViewCreated(
    ...
    private static class WrapperFactory2 implements Factory2 {
        ...
        protected final TagViewFactory mTagViewFactory;

        public WrapperFactory2(Factory2 factory2, TagViewFactory tagViewFactory) {
            mFactory2 = factory2;
            mTagViewFactory = tagViewFactory;
        }
    ...
    private static class PrivateWrapperFactory2 extends WrapperFactory2 {
        ...
        public PrivateWrapperFactory2(Factory2 factory2, TagViewLayoutInflater inflater, TagViewFactory tagViewFactory) {
            super(factory2, tagViewFactory);
            mInflater = inflater;
        }
